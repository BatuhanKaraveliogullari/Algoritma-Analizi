...
public class Kmeans
{
    private static final int NUM_CLUSTERS = 2;    // Toplam küme sayısı.
    ...
    private static void initialize()
    {
        ...
        centroids.add(new Centroid(1.0, 1.0)); // ilk merkez
        centroids.add(new Centroid(5.0, 7.0)); // ikinci merkez
    ...
    private static void kMeanCluster() //O(N*k)
    {
        final double bigNumber = Math.pow(10, 10);    
        double minimum = bigNumber;                   
        double distance = 0.0;                        //default merkez uzaklığı
        int sampleNumber = 0;
        int cluster = 0;
